...
<Container>
  <Word scale={147.5}>Replacing</Word>
  <Word scale={44} italic>
    {"Eval"}
  </Word>
  <Word scale={69.5}>with</Word>
  <Word scale={21.5}>a</Word>
  <Word scale={180}>Web Worker</Word>
</Container>
...
[![Screen Shot 2014-05-16 at 4.40.48 PM.png](https://svbtleusercontent.com/jrrtyhyjsw4dza_small.png)](https://svbtleusercontent.com/jrrtyhyjsw4dza.png)
...
[![Screen Shot 2014-05-16 at 4.38.25 PM.png](https://svbtleusercontent.com/bqdcncvzs9ctlg_small.png)](https://svbtleusercontent.com/bqdcncvzs9ctlg.png)
...
[![good_vs_eval.jpg](https://svbtleusercontent.com/f9imayjtiyhq5a_small.jpg)](https://svbtleusercontent.com/f9imayjtiyhq5a.jpg)
