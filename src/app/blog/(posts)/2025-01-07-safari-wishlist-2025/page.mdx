...
The last few years have also seen massive improvements in the development of Safari. This _may_ be a coincidence. Credit
...
(or another Chromium-based browser) for certain use-cases, but in the last few years there have been
fewer and fewer reasons to need Chrome.

On the flip side, there are a few features in Safari that make it difficult for me to switch away and
...
extensions as apps, deal with Apple's notarization or worse, app review. However, this has also enabled
...
Also in 2025, I would love to see Safari and Webkit win the debate that masonry belongs in Grid Layout.
